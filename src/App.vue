...
<template>
  <div id="app">
    <Header/>
    <main>
      <b-row class="row d-flex justify-content-center align-items-center">
      <label :for="text-search" class="w-auto">Search:</label>
      <b-form-input :id="text-search" :text="text" class="w-25"></b-form-input>
      </b-row>
      <div class="row mt-5">
        <FilterList/>
